...
/**
 The base class for all poney_app modules
 */
...
/**
 poney_app Platform calls this method on startup.
 */
-(void)startup;

/**
 poney_app Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 poney_app Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 poney_app Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 poney_app Platform calls this method on resume.
 @param sender The sender of the event.
 */
