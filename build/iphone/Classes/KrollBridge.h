...
@interface poney_appObject : KrollCoverageObject {
#else
@interface poney_appObject : KrollObject {
#endif
@private
...
extern NSString * poney_app$ModuleRequireFormat;
