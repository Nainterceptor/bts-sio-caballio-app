...
// in simulator we redefine to format for poney_app Developer console
...
{\
	NSString * exceptionName = [@"org.poney_app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.poney_app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIponey_appNativeItemNone = -1, 
	UIponey_appNativeItemSpinner = -2,
	UIponey_appNativeItemProgressBar = -3,
	
	UIponey_appNativeItemSlider = -4,
	UIponey_appNativeItemSwitch = -5,
	UIponey_appNativeItemMultiButton = -6,
	UIponey_appNativeItemSegmented = -7,
	
	UIponey_appNativeItemTextView = -8,
	UIponey_appNativeItemTextField = -9,
	UIponey_appNativeItemSearchBar = -10,
	
	UIponey_appNativeItemPicker = -11,
	UIponey_appNativeItemDatePicker = -12,
	
	UIponey_appNativeItemInfoLight = -13,
	UIponey_appNativeItemInfoDark = -14,
	
	UIponey_appNativeItemDisclosure = -15,
	
	UIponey_appNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all poney_app instances of
