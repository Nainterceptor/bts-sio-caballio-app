...
/**
 Base class for all poney_app views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the poney_app view hierarchy (such as wrapped iOS UIViews) was touched.
