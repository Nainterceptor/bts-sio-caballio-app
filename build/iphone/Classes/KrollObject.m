...
//@interface poney_appObject : NSObject
//@end

@interface poney_appObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[poney_appObject class]])
		{
			for (NSString *key in [[(poney_appObject*)o modules] allKeys])
			{
