...
static NSString * const kponey_appJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_poney_appInjection
{
	...
	[html appendString:kponey_appJavascript];
...
{
	// attempt to make well-formed HTML and inject in our poney_app bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _poney_appInjection]];
